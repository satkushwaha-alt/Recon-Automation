...
import { facilityId15InternalException } from "../../Static_Files/ApproveReject/data";
...
//Internal Exception - Aggregate and Match 15 records
test("approveReject11", async ({ page }) => {
  ...
  await selectRowByValues(page, facilityId15InternalException);
  //aggregate action
  await page
    .getByText(
      facilityId15InternalException[facilityId15InternalException.length - 1],
    )
    .click({
      button: "right",
    });
