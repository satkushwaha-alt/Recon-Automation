...
test("approveReject14", async ({ page }) => {
  ...
  await page.getByRole('button', { name: 'Refresh' }).click();
  await page.getByRole('button', { name: 'Clear Filters and Grouping' }).click();
  selectRowByValues(page, aggregateCloseEE);
  ...
  await page.getByRole('button', { name: 'Update' }).click();
  signoutLogin(page,"mayadav_16@ivp.in","Ivp@123");
    await openFromBreakManagement(
    page,
    "Copy of Break_Management_Position_AP_RJ",
    "Recon",
  ...
  signoutLogin(page,"mayadav_re-arch@ivp.in","Ivp@123");
    await openFromBreakManagement(
    page,
    "Copy of Break_Management_Position_AP_RJ",
    "Recon",
  ...
  await page.getByRole('button', { name: 'Refresh' }).click();
  await page.getByRole('button', { name: 'Clear Filters and Grouping' }).click();
  selectRowByValues(page, aggregatePairClose);
  ...
  await page.getByRole('button', { name: 'Clear Filters and Grouping' }).click();
  await page.getByRole('button', { name: 'Clear Filters and Grouping' }).click();
  await page.locator(selectFilterByAttribute("AF"));

  await page.locator('#floatingFilter_AF_adaptableId').getByRole('textbox').click();
  await page.locator('[id*= "floatingFilter_AF_adaptableId"]').locator('[data-name*= "floating-filter-button"] ').click();
    await page.locator('[id*= "floatingFilter_AF_adaptableId"]').locator('[data-name*= "expand-filter"] ').click();
